...
//    	menu.add(0, 1, 1, "Multi Player").setIcon(R.drawable.icon);
    	...
    	menu.add(0, 4, 4, "Savant").setIcon(R.drawable.help);
//    	menu.add(0, 5, 5, "Cleanup").setIcon(R.drawable.cleanup);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 4:
			...
			DialogTool.launchBrowser(DoomClient.this
					, "http://www.savant.mobi/Doom.html");
			return true;
		case 5:
			// Cleanup
			if ( mGameStarted) {
    ...
    private boolean loadLibrary() {
		...
		// Good Spot for this message
    	MessageBox("Hint: Hit your phone's back arrow key to get to the main menu, then press enter or touch the checkmark to play Doom.");
    	MessageBox("Hint: If you need to navigate the game menu you can switch between touchscreen and keyboard controls.");
