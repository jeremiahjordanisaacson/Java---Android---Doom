...
import www.savant.com.DoomClient;
import www.savant.com.DoomClient.eNavMethod;
...
public class DoomTools 
{
    ...
    public static final String DOOM_FOLDER = "/res/raw" + File.separator ;
	...
	// Compressed Lib in assets folder 
